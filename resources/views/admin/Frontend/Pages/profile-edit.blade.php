        ...
        <div class="row">
            <div class="col-md-3 border-right">
                <div class=" profile-img d-flex flex-column align-items-center text-center p-3 py-5">
                    <img class=" mt-5" width="100px" src="{{url('/uploads//'.auth()->user()->image)}}">
            ...
            <div class="col-md-5 border-right">
                <div class="p-3 py-5">
                    ...
                    <div class="row mt-2">
                        <div class="col-md-12"><label class="labels">Full Name</label><input type="text" name="name" class="form-control" placeholder="Enter Your fullName" value="{{ auth()->user()->name }}"></div>
                    </div>
                    <div class="row mt-2">
                    ...
                    <div class="row mt-3">
                        <div class="col-md-12"><label class="labels">Email ID</label><input type="text" name="email" class="form-control" placeholder="enter email id" value="{{ auth()->user()->email }}"></div>
                    ...
                    <div class="mt-5 text-center"><button class="btn btn-primary profile-button" type="submit"77>Save Profile</button></div>
