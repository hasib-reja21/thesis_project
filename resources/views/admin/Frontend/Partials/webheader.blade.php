                ...
                <div class="row">
                    <div class="col-sm-7">
                        <ul class="header__info-list d-flex flex-wrap align-items-center justify-content-sm-start justify-content-center">
                            <li><a href="https://thesoftking.com/contact"><i class="fa-solid fa-envelope"></i> <span class="__cf_email__" data-cfemail="95e6faf3e1e2f4e7f0d5e1fdf0e6faf3e1fefcfbf2bbf6faf8">[email&#160;protected]</span></a></li>
                            <li><a href="https://thesoftking.com/contact"><i class="fa-brands fa-whatsapp"></i> +8801825132226</a></li>
                        </ul>
                    </div>
                    <div class="col-sm-5 mt-sm-0 mt-2">
                        <ul class="header__info-list d-flex flex-wrap align-items-center justify-content-sm-end justify-content-center">
                            ...
                            <li><a href="{{route('customer.login')}}"><i class="fa-solid fa-right-to-bracket "></i>Login</a></li>
                            <li><a href="{{route('customer.registration')}}"><i class="fa-solid fa-users"></i>Register</a></li>
